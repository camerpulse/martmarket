-- First add a unique constraint on language_code and translation_key
ALTER TABLE translations ADD CONSTRAINT translations_lang_key_unique UNIQUE (language_code, translation_key);

-- Now insert the About page translations with proper conflict handling
